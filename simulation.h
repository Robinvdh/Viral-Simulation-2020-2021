...
{
    public:
        Simulation(int width, int height, int infectionTime, std::unique_ptr<Canvas> canvas, std::unique_ptr<StatisticsHandler> sh);
    ...
    private:
        void setStrategy(); // Determine the strategy for the subjects
